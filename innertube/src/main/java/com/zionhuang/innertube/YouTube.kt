...
import com.zionhuang.innertube.models.YouTubeClient.Companion.STREAM_FALLBACK_CLIENTS
...
object YouTube {
    ...
    suspend fun player(videoId: String, playlistId: String? = null): Result<PlayerResponse> = runCatching {
        ...
        if (safePlayerResponse.playabilityStatus.status != "OK" ||
            safePlayerResponse.streamingData?.adaptiveFormats.isNullOrEmpty()
        ) {
            return@runCatching innerTube.player(IOS, videoId, playlistId).body<PlayerResponse>()
        }
